...
local AkiQB = Instance.new("ScreenGui")
...
local PassDurationCard = Instance.new("Frame")
...
AkiQB.Name = "AkiQB"
AkiQB.Parent = game.Players.LocalPlayer:WaitForChild("PlayerGui")
AkiQB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling
...
AngleCard.Parent = Main
AngleCard.BackgroundColor3 = Color3.fromRGB(25, 23, 32)
AngleCard.BackgroundTransparency = 0.100
AngleCard.Position = UDim2.new(0.0492328368, 0, 0.116959102, 0)
AngleCard.Size = UDim2.new(0.123956323, 0, 0.557099044, 0)

Val.Name = "Val"
Val.Parent = AngleCard
...
UIGradient_2.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(79, 86, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 73, 128))}
UIGradient_2.Parent = Control

Control_2.Name = "Control"
Control_2.Parent = AngleCard
...
ModeCard.Position = UDim2.new(0.240348816, 0, 0.116959147, 0)
ModeCard.Size = UDim2.new(0.123856634, 0, 0.556999981, 0)

Val_2.Name = "Val"
Val_2.Parent = ModeCard
...
Title_2.TextSize = 29.000
Title_2.TextWrapped = true

UIGradient_4.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(79, 86, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 73, 128))}
UIGradient_4.Parent = Title_2

Control_3.Name = "Control"
Control_3.Parent = ModeCard
...
PowerCard.Size = UDim2.new(0.123856634, 0, 0.556999981, 0)
...
PassDurationCard.Name = "PassDurationCard"
PassDurationCard.Parent = Main
PassDurationCard.BackgroundColor3 = Color3.fromRGB(25, 23, 32)
PassDurationCard.BackgroundTransparency = 0.100
PassDurationCard.Position = UDim2.new(0.615429819, 0, 0.116959147, 0)
PassDurationCard.Size = UDim2.new(0.123856634, 0, 0.556999981, 0)

Val_4.Name = "Val"
Val_4.Parent = PassDurationCard
...
Title_4.Name = "Title"
Title_4.Parent = PassDurationCard
...
Title_4.Text = "Pass Duration"
Title_4.TextColor3 = Color3.fromRGB(255, 245, 249)
Title_4.TextScaled = true
Title_4.TextSize = 16.000
Title_4.TextWrapped = true

UIGradient_7.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(79, 86, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 73, 128))}
UIGradient_7.Parent = Title_4

UICorner_4.CornerRadius = UDim.new(0.100000001, 0)
UICorner_4.Parent = PassDurationCard
...
RouteCard.Size = UDim2.new(0.123856634, 0, 0.556999981, 0)
...
Title_5.TextSize = 29.000
Title_5.TextWrapped = true

UIGradient_8.Color = ColorSequence.new{ColorSequenceKeypoint.new(0.00, Color3.fromRGB(79, 86, 255)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 73, 128))}
